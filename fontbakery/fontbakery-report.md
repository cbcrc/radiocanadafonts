...
* 🔥 **FAIL** The file 'Radio-Canada[wdth,wght].ttf' must be renamed to 'RadioCanada[wdth,wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
